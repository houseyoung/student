...
-- ----------------------------
BEGIN;
INSERT INTO `t_course` VALUES ('1', 'C++程序设计', '30', '3', '周东岱', '314');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `t_student` VALUES ('1', '2011012488', '2011012488', '杨昌昊', '男', '1', '1993-01-01', '山东省济南市', '计算机'), ('3', '2011012002', '2011012001', '李四', '女', '1', '1992-05-05', '山东省青岛市', '暂无');
COMMIT;
