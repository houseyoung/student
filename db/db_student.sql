...
insert  into `t_class`(`id`,`class_name`,`department_id`) values (1,'软件1班',1),(2,'软件2班',1),(3,'软件3班',1),(7,'图书馆1班',8),(9,'计算机1班',4),(13,'计算机3班',4);
...
insert  into `t_student`(`id`,`student_id`,`password`,`student_name`,`sex`,`class_id`,`birthday`,`hometown`,`interest`) values (1,'2011012488','827ccb0eea8a706c4c34a16891f84e7b','杨昌昊','男',1,'1993-01-01','山东省济南市','计算机'),(3,'2011012002','c0da6cbc0094c8bf7edad2d296a9ebe9','李四','女',1,'1992-05-05','山东省青岛市','暂无'),(17,'2011012001','827ccb0eea8a706c4c34a16891f84e7b','张三','男',7,'1993-06-06','北京市','吃饭');
...
insert  into `t_user`(`id`,`username`,`password`,`role`) values (3,'admin','21232f297a57a5a743894a0e4a801fc3','1'),(4,'role2','84ccdc5607f6af253d3ad709b382ef3f','2'),(5,'123','202cb962ac59075b964b07152d234b70','1');
...
/* Procedure structure for procedure `2` */

/*!50003 DROP PROCEDURE IF EXISTS  `2` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `2`()
