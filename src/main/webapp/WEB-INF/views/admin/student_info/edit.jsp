					...
					<div class="row">
						...
						<div class="col-sm-12">
							<div class="panel panel-default">
								...
								<form id="defaultForm" class="form-horizontal" action="${website}admin/student_info/edit?id=${studentDto.id}" method="post">
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="col-sm-3">
												<input type="text" class="form-control" name="departmentName" value="${studentDto.departmentName}">
										    </div>
										</div>
										<div class="form-group">
											<div class="col-sm-1 col-sm-offset-3">
											...
											<div class="col-sm-3">
												<input type="text" class="form-control" name="schoolName" value="${studentDto.schoolName}">
										    </div>
										</div>
										<div class="form-group">
											<div class="col-sm-1 col-sm-offset-3">
