						...
						<div class="col-sm-12">
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4>系信息列表</h4>
									<a class="btn btn-primary add" href="${website}admin/department/insert"><i class="fa fa-plus"></i>&nbsp;添加</a>
								</div>
								<div class="panel-body">
									<form class="form-horizontal" action="${website}admin/department" method="post">
										...
										<table class="table table-hover table-bordered">
											...
											<tbody>
												...
												<tr>
									    			...
									    			<td>
									    				<a class="btn btn-primary btn-xs" href="${website}/admin/department/edit?id=${departmentDto.id}"><i class="fa fa-pencil"></i>&nbsp;编辑</a>
									    				<a class="btn btn-primary btn-xs J_del" href="${website}/admin/department/delete?id=${departmentDto.id}"><i class="fa fa-times"></i>&nbsp;删除</a>
									    			</td>
									    		</tr>
												</c:forEach>
											</tbody>
