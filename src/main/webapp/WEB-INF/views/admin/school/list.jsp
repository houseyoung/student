						...
						<div class="col-sm-12">
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4>学院信息列表</h4>
									<a class="btn btn-primary add" href="${website}admin/school/insert"><i class="fa fa-plus"></i>&nbsp;添加</a>
								</div>
										...
										<table class="table table-hover table-bordered">
											...
											<c:forEach var="school" items="${listSchool}">
												<tr>
									    			...
									    			<td>
									    				<a class="btn btn-primary btn-xs" href="${website}admin/school/edit?id=${school.id}"><i class="fa fa-pencil"></i>&nbsp;编辑</a>
									    				<a class="btn btn-primary btn-xs J_del" href="${website}admin/school/delete?id=${school.id}"><i class="fa fa-times"></i>&nbsp;删除</a>
									    			</td>
									    		</tr>
											</c:forEach>
											</tbody>
